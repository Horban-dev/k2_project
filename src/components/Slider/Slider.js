...
const Slider = ({id}) => {
  const items = [
    {id: 1, src: "https://upload.wikimedia.org/wikipedia/commons/e/e7/Everest_North_Face_toward_Base_Camp_Tibet_Luca_Galuzzi_2006.jpg",  alt: "First slide"},
    {id: 2, src: "https://www.meteorologiaenred.com/wp-content/uploads/2020/10/ascenso-del-k2.jpg",  alt: "Second slide"},
    {id: 3, src: "https://www.mensjournal.com/wp-content/uploads/2021/07/k2.jpg?quality=78&strip=all",  alt: "Third slide"},
